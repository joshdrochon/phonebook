...
class PhoneBook
{
  ...
  //Three methods, main, add-contact, and look-up contact

  //Pascal case in C# for functions

  static void Main()
  {
    Console.WriteLine("MAIN MENU");
    Console.WriteLine("Would you like to add someone to the phonebook? ['Y' for yes. 'Enter' for no]");
    ...
    {
      Console.WriteLine("Would you like to look up a number in your phonebook? ['Y' for yes. 'Enter' for no]");

      string lookUp = Console.ReadLine().ToUpper();
      ...
      else
      {
        ...
        string finishAnswer = Console.ReadLine().ToUpper();
